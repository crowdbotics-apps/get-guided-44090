"""
Django settings for get_guided_44090 project.
...
ROOT_URLCONF = 'get_guided_44090.urls'
...
WSGI_APPLICATION = 'get_guided_44090.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "get_guided_44090 API",
    "DESCRIPTION": "API documentation for get_guided_44090 App",
    "VERSION": "v1",
}
